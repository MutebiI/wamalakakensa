    ...
    <footer className="bg-gray-900 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Brand Section with School Logo */}
          <div className="col-span-1 md:col-span-2">
            {/* School Logo and Name */}
            <div className="flex items-center mb-4">
              <div className="w-12 h-12   flex items-center justify-center mr-3">
                {/* <span className="text-white rounded-full bg-blue-600 font-bold text-lg">SL</span> */}
            ...
            <p className="text-gray-300 max-w-md mb-4">
              We invest in Education Since 1980. Preparing students for success
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["About", "Academics", "Admissions", "Students", "Contact"].map(
                (item) => (
                  <li key={item}>
                    <Link
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 text-gray-400 text-sm flex items-center space-x-2">
